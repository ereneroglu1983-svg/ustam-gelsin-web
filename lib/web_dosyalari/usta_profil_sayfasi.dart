...
class _UstaProfilSayfasiState extends State<UstaProfilSayfasi> {
  ...
  void _updateUstaBildirimBilgisi(String uid, String? uzmanlikAlani) {
    if (uzmanlikAlani != null) {
      _notificationService.updateUserToken(uid, uzmanlikAlani);
    }
  }
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              await _acilServisi.cagriyiKabulEt(doc.id);
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, userSnapshot) {
          ...
          String uzmanlik = userData?['uzmanlikAlani'] ?? "Genel";
          _updateUstaBildirimBilgisi(user.uid, uzmanlik);
