// lib/core/theme/usta_theme.dart
...
class UstaTheme {
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      // GÜNCELLENDİ: minimumSize'ı Size.zero yaparak butonların
      // Row içinde kendi boyutlarına göre şekillenmesine izin verdik.
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          minimumSize: Size.zero, // Artık Row içinde ezilmeyecek
