// lib/features/home/screens/ai_is_secimi.dart

import 'package:flutter/material.dart';
import 'package:ustam_gelsin/core/models/ilan_model.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'ai_ilan_detay_sayfasi.dart';

class AiIsSecimi extends StatefulWidget {
  const AiIsSecimi({super.key});

  @override
  State<AiIsSecimi> createState() => _AiIsSecimiState();
}

class _AiIsSecimiState extends State<AiIsSecimi> {
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => AiIlanDetaySayfasi(ilan: yeniIlan),
                        ),
                      );
                    },
                  ),
