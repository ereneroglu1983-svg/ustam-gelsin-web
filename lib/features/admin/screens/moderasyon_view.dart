...
class ModerasyonView extends StatelessWidget {
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(icon: const Icon(Icons.local_offer, color: Colors.amber, size: 16), onPressed: () => _teklifVer(context, ilanlar[i].id, data)),
  ...
  Future<void> _teklifVer(BuildContext context, String ilanId, Map<String, dynamic> data) async {
    try {
      // İlan içindeki konum bilgisinden sehir bilgisini almaya çalışıyoruz, yoksa "Belirtilmemiş" geçiyoruz.
      String sehir = data['konumMetin'] ?? "Belirtilmemiş";
