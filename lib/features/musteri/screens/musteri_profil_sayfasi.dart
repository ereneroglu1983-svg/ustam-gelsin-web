        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              // CARD 1: HEMEN USTA BUL (YENİ PARLAMENT MAVİSİ DEGRADE)
              Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFF0F4C81), Color(0xFF0A3356)], // Derin Parlament Mavisi Tonları
              ...
              // CARD 2: 7/24 ACİL USTA KARTI (KOYU KIRMIZI DEGRADE)
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                child: GestureDetector(
                  onTap: () => Navigator.push(
